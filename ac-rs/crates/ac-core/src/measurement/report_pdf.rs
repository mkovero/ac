...
fn draw_title(layer: &PdfLayerReference, font_bold: &IndirectFontRef, y: f32, text: &str) -> f32 {
    layer.use_text(
        text,
        SIZE_TITLE,
        Mm(MARGIN_MM),
        Mm(y - SIZE_TITLE * 0.35),
        font_bold,
    );
