...
| Crate | Binary | Role |
|-------|--------|------|
| `ac-core` | — | Pure library — analysis, CWT, generator, calibration, config, conversions, IEC 61260-1 filterbank, Farina log-sweep IR. No sockets, no global state. 91 unit tests. |
