...
cargo test                        # 322 tests (ac-core 112, ac-cli 55, ac-daemon 43 + 10 it, ac-ui 102)
```
...
| Crate | Binary | Role |
|-------|--------|------|
| `ac-core` | — | Pure library — analysis, CWT, generator, calibration, config, conversions, IEC 61260-1 filterbank, Farina log-sweep IR, IEC 61672-1 A/C/Z weighting, AES17 idle-channel noise. No sockets, no global state. 112 unit tests. |
