...
#[allow(dead_code)]
pub static PKG_AUTHORS: &str = "Yotaro Kubo <yotaro@ieee.org>";
#[doc=r#"The name of the package."#]
#[allow(dead_code)]
pub static PKG_NAME: &str = "flacenc";
#[doc=r#"The description."#]
#[allow(dead_code)]
pub static PKG_DESCRIPTION: &str = "Pure rust library for embedding FLAC encoder in your application.";
#[doc=r#"The homepage."#]
#[allow(dead_code)]
...
#[allow(dead_code)]
pub static PKG_REPOSITORY: &str = "https://github.com/yotarok/flacenc-rs/";
...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/mui/.rustup/toolchains/1.95.0-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/mui/.rustup/toolchains/1.95.0-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[allow(dead_code)]
pub static FEATURES: [&str; 4] = ["DEFAULT", "LOG", "PAR", "SERDE"];
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub static FEATURES_STR: &str = "DEFAULT, LOG, PAR, SERDE";
#[doc=r#"The features as above, as lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE: [&str; 4] = ["default", "log", "par", "serde"];
#[doc=r#"The feature-string as above, from lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE_STR: &str = "default, log, par, serde";
#[doc=r#"The output of `/home/mui/.rustup/toolchains/1.95.0-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.95.0 (59807616e 2026-04-14)";
#[doc=r#"The output of `/home/mui/.rustup/toolchains/1.95.0-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/mui/.rustup/toolchains/1.95.0-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
