...
Executes `work/handoff/handoff-rig-verify-125.md` at the fixed 3 m on-axis position, and
the parts of `work/rig/rig-verify-queue.md` that need no microphone movement.
