...
Executes `$AC_HOME/handoff/handoff-rig-session-3.md`. Rig: RME Babyface Pro, 96 kHz native both
...
- **Capture discontinuity warnings, continuously.** The daemon log fills with
  ...
  occurrence and it is constant. See `$AC_HOME/handoff/handoff-capture-contiguity.md`.
