...
# Runs read-only against the tree: architect decides, developer implements.
# The GitHub tools stay available so it can post its comment and move labels.
